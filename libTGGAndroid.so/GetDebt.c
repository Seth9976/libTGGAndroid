long GetDebt(int param0, int* param1, int param2, int param3) {
    long v0;
    int v1;
    int v2;
    int v3;
    ...
    if(*(param1 + 0x66b) >= 1) {
        if((uint32_t)v8 < 3) {
            ...
            do {
                ...
                int v19 = v2 != 0xc00 ? v16 & 1: 0;
                char v20 = (param2 + 1 ? 1009: 6) == v11;
                char v21 = (param2 + 1 ? 1009: 6) == v10;
                v2 = v21;
                v3 = (param2 != v5 ? v2 & 1: 0) | (v13 != 0xc00 ? v14 & 1: 0);
            ...
            loc_7D1F4C:
                ...
                v8 -= v4;
                do {
                    if((param2 + 1 ? 1009: 6) == *(ptr0 + 2) && *(ptr0 + 1) == param2 && *ptr0 == 0xc00) {
