...
unsigned int std::__ndk1::__sort4<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(DomGfx** param0, DomGfx** param1, DomGfx** param2, DomGfx** param3, bool (*&)(DomGfx const*, DomGfx const*) param4) {
    DomGfx* ptr0;
    int result;
    int v0;
