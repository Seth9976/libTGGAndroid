long sub_CE1300(long* param0, long param1, uint64_t* param2, long* param3, long param4, uint64_t* param5, long param6, long param7) {
    long v0;
    long* ptr0;
    long* ptr1;
    *param2 = param0;
            ...
            if(param6 >= (uint64_t)ptr4) {
                if((long*)((long)(long*)((long)ptr4 >>> 7L) & 0x1L) && (uint32_t)ptr4 < 194) {
                    ...
                    *ptr3 = (uint16_t)ptr4;
                    ...
                    ptr4 = (uint64_t)(uint8_t)(long*)((long)ptr1 & 0x3fL) | ((uint64_t)((uint64_t)(uint8_t)(v0 & 0x3fL) | ((uint64_t)(long*)((long)ptr4 & 0xfffffffffffffL) << 6)) << 6);
                    if((uint64_t)(uint16_t)ptr4 > param6) {
                        return 2L;
                    }
                    *ptr3 = (uint16_t)ptr4;
                    ptr0 = ptr2 + 3L;
                    ...
                    if((long)(long*)(param4 - (long)ptr3) < 4L) {
                        return 1L;
                    }
                    ...
                    *ptr3 = ((uint16_t)((uint32_t)(uint8_t)(long*)((long)(long*)((long)ptr1 >>> 4L) & 0x3L) | ((uint32_t)(((uint32_t)(((uint8_t)(v1 & 0x3fL) >>> 2) & 0xF) | ((uint32_t)(uint8_t)(((uint32_t)(uint8_t)((v0 >>> 4L) & 0x3L) | ((uint32_t)(long*)((long)ptr4 & 0x3fffffffL) << 2)) & 0x1f) << 4) | ((uint32_t)((v1 >>> 11L) & "ctIwLb1EE16do_positive_signEv") << 9) | ((uint32_t)0 << 30)) & 0x3fffffff) << 2)) + 16320) | 0xd800;
                    *param5 = (long*)(ptr3 + 1);
                    *(ptr3 + 1) = (uint16_t)((uint32_t)(uint8_t)(long*)((long)ptr5 & 0x3fL) | ((uint32_t)(uint8_t)(long*)((long)ptr1 & 0xfL) << 6) | ((uint32_t)(long*)((long)(long*)((long)ptr5 >>> 10L) & 0x3fffffL) << 10)) | 0xdc00;
                    ptr0 = (char*)*param2 + 4L;
                }
                *param2 = ptr0;
                ptr3 = (char*)*param5 + 2L;
                *param5 = (short*)((char*)*param5 + 2L);
                ptr2 = *param2;
                if(param1 <= (uint64_t)ptr2) {
                    return 0L;
                }
