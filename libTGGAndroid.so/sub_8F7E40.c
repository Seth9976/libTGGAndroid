long sub_8F7E40(long param0, long param1, long param2, uint64_t* param3, long param4) {
    long* ptr0;
    long v0 = param0;
    if(param2 != 0L) {
        long v1 = 0L;
        ...
        do {
            ...
            long v6 = *(ptr2 + 1);
            long* ptr3 = ptr1 + 4;
            long v7 = ((uint64_t)(uint8_t)(v5 >>> 56L) | ((uint64_t)(uint8_t)(v5 >>> 48L) << 8) | ((uint64_t)(uint8_t)(v5 >>> 40L) << 16) | ((uint64_t)(uint8_t)(v5 >>> 32L) << 24) | ((uint64_t)(uint8_t)(v5 >>> 24L) << 32) | ((uint64_t)(uint8_t)(v5 >>> 16L) << 40) | ((uint64_t)(uint8_t)(v5 >>> 8L) << 48) | ((uint64_t)(uint8_t)v5 << 56)) ^ *ptr1;
            long v8 = *(ptr1 + 2) ^ v7;
            ...
            long v96 = (((uint64_t)(((v87 ^ v78) ^ v77) ^ v89) * 0x100000000000000L) | ((uint64_t)((((uint8_t)v87 ^ (uint8_t)v88) ^ (uint8_t)v83) ^ (uint8_t)v84) * 0x10000000000L) | (uint64_t)(uint32_t)(v95 & 0xffffffL) | ((uint64_t)(((uint8_t)v79 ^ (uint8_t)v88) ^ (uint8_t)v89) << 24) | ((uint64_t)(uint32_t)(v95 >>> 32L) << 32)) ^ (*(ptr0 + 3) ^ v46);
